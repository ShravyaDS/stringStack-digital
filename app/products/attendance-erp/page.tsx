...
export default function AttendanceERPPage() {
  ...
  return (
    <div className="pt-28 pb-20 bg-slate-50 dark:bg-[#090D16] text-slate-900 dark:text-white min-h-screen transition-colors duration-200">
      
      {/* ── Hero Section ── */}
      <section className="py-12 md:py-20 relative overflow-hidden border-b border-slate-200 dark:border-[#1F2937]">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] bg-emerald-600/10 rounded-full blur-3xl pointer-events-none -z-0 opacity-40 dark:opacity-100" />
        <div className="absolute inset-0 bg-[radial-gradient(rgba(0,0,0,0.04)_1px,transparent_1px)] dark:bg-[radial-gradient(rgba(255,255,255,0.06)_1px,transparent_1px)] [background-size:32px_32px] opacity-40 pointer-events-none -z-0" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl space-y-5">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-mono font-semibold px-2.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/25">
                Workforce OS
              </span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-3">
              <button
                ...
                className="btn-primary px-6 py-3 text-sm font-semibold cursor-pointer active:scale-95 transition-transform flex items-center gap-2 text-white"
              >
      ...
      <section className="py-10 bg-slate-100/60 dark:bg-[#070B14] border-b border-slate-200 dark:border-[#1F2937]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-4 rounded-xl bg-white dark:bg-[#0E1528] border border-slate-200 dark:border-[#1F2937] shadow-xs">
              <div className="text-3xl sm:text-4xl font-extrabold text-emerald-600 dark:text-emerald-400 font-mono">100%</div>
              <div className="text-xs text-slate-900 dark:text-white font-bold mt-1">Verified Presence</div>
              <div className="text-[11px] font-mono text-slate-500 dark:text-slate-400">Zero proxy check-ins</div>
            </div>
            <div className="p-4 rounded-xl bg-white dark:bg-[#0E1528] border border-slate-200 dark:border-[#1F2937] shadow-xs">
              <div className="text-3xl sm:text-4xl font-extrabold text-blue-600 dark:text-blue-400 font-mono">&lt; 2s</div>
              <div className="text-xs text-slate-900 dark:text-white font-bold mt-1">Biometric Sync Speed</div>
              <div className="text-[11px] font-mono text-slate-500 dark:text-slate-400">TCP/IP direct push</div>
            </div>
            <div className="p-4 rounded-xl bg-white dark:bg-[#0E1528] border border-slate-200 dark:border-[#1F2937] shadow-xs">
              <div className="text-3xl sm:text-4xl font-extrabold text-indigo-600 dark:text-indigo-400 font-mono">90%</div>
              <div className="text-xs text-slate-900 dark:text-white font-bold mt-1">Payroll Time Saved</div>
              <div className="text-[11px] font-mono text-slate-500 dark:text-slate-400">1-click reconciliation</div>
            </div>
            <div className="p-4 rounded-xl bg-white dark:bg-[#0E1528] border border-slate-200 dark:border-[#1F2937] shadow-xs">
              <div className="text-3xl sm:text-4xl font-extrabold text-purple-600 dark:text-purple-400 font-mono">50,000+</div>
              <div className="text-xs text-slate-900 dark:text-white font-bold mt-1">Capacity Per Tenant</div>
              <div className="text-[11px] font-mono text-slate-500 dark:text-slate-400">Horizontal microservices</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="modules" className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {modules.map((mod) => (
            <div
              key={mod.id}
              id={mod.id}
              className="p-6 sm:p-7 rounded-2xl bg-white dark:bg-[#0E1528] border border-slate-200 dark:border-[#1F2937] space-y-5 shadow-sm dark:shadow-lg hover:border-emerald-500/40 transition-all duration-300 flex flex-col justify-between"
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-[#070B14] border border-slate-200 dark:border-[#1F2937] flex items-center justify-center">
                    {mod.icon}
                  </div>
                  <span className="text-[11px] font-mono px-2.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/25 font-semibold">
                    {mod.badge}
                  </span>
                </div>
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-[#1F2937] space-y-2">
        ...
        {/* ── Live Demo Callout ── */}
        <div className="mt-14 p-8 sm:p-12 rounded-3xl bg-white dark:bg-[#0E1528] border border-slate-200 dark:border-[#1F2937] shadow-xl dark:shadow-2xl text-center space-y-6 relative overflow-hidden">
          ...
          <div>
            <button
              onClick={openBookingModal}
              className="btn-primary px-7 py-3.5 text-sm font-semibold cursor-pointer active:scale-95 transition-transform flex items-center gap-2 mx-auto text-white"
            >
