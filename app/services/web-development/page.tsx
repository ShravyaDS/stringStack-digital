      ...
      <section className="py-16 sm:py-20 bg-white border-b border-[#E5E8ED]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 sm:p-8 rounded-xl bg-[#F8FAFC] border border-[#E5E8ED] space-y-3 hover:border-[#CBD5E1] transition-colors">
              <div className="w-10 h-10 rounded-lg bg-[#EEF2FF] border border-blue-100 flex items-center justify-center text-[#2554EB]">
                <Zap className="w-5 h-5" />
              </div>
              <h3 className="text-lg font-bold text-[#0F172A]">Sub-Second Edge SSR</h3>
            ...
            <div className="p-6 sm:p-8 rounded-xl bg-[#F8FAFC] border border-[#E5E8ED] space-y-3 hover:border-[#CBD5E1] transition-colors">
              ...
              <h3 className="text-lg font-bold text-[#0F172A]">Resilient Data Pipelines</h3>
              <p className="text-xs sm:text-sm text-[#5B6472] leading-relaxed font-normal">
            ...
            <div className="p-6 sm:p-8 rounded-xl bg-[#F8FAFC] border border-[#E5E8ED] space-y-3 hover:border-[#CBD5E1] transition-colors">
              <div className="w-10 h-10 rounded-lg bg-blue-50 border border-blue-100 flex items-center justify-center text-[#2554EB]">
                <ShieldCheck className="w-5 h-5" />
              </div>
              <h3 className="text-lg font-bold text-[#0F172A]">Enterprise Security &amp; RBAC</h3>
              <p className="text-xs sm:text-sm text-[#5B6472] leading-relaxed font-normal">
      ...
      <section id="sprints" className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {sprints.map((s) => (
            <div
              key={s.sprint}
              className="p-6 sm:p-8 rounded-xl bg-white border border-[#E5E8ED] space-y-5 shadow-[0_1px_3px_rgba(0,0,0,0.03)] hover:border-[#CBD5E1] transition-colors flex flex-col justify-between"
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono font-bold px-2.5 py-0.5 rounded-full bg-[#EEF2FF] text-[#2554EB] border border-blue-100">
                    {s.sprint}
                  </span>
                  <span className="text-xs font-mono text-[#64748B] font-semibold">{s.duration}</span>
                </div>

                <h3 className="text-lg sm:text-xl font-bold text-[#0F172A]">{s.title}</h3>
                <p className="text-xs sm:text-sm text-[#5B6472] leading-relaxed font-normal">{s.description}</p>
              </div>
              ...
              <div className="pt-4 border-t border-[#E5E8ED] space-y-2">
                ...
                {s.deliverables.map((del) => (
                  <div key={del} className="flex items-center gap-2 text-xs text-[#334155]">
