...
const CUSTOMER_RESULTS_DATA: MetricItem[] = [
  {
    id: "ip-ownership",
    metric: "100%",
    metricColor: "from-blue-400 via-blue-300 to-blue-400",
...
export function CustomerResults() {
  ...
  return (
    <section id="customer-results" className="dark-section py-28 bg-[#090D16] border-y border-white/10 relative overflow-hidden">
      {/* Ambient lighting */}
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 text-sm font-semibold text-white group hover:text-blue-400 transition-colors py-2"
              >
                <span className="underline underline-offset-8 decoration-blue-400/50 group-hover:decoration-blue-400">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-10">
            {CUSTOMER_RESULTS_DATA.map((item) => (
              ...
              >
                ...
                {/* Badge */}
                <div className="pt-2">
                  <span className="inline-flex items-center gap-1.5 text-[10px] font-mono text-blue-400 font-semibold px-2.5 py-1 rounded-md bg-white/[0.04] border border-white/[0.08]">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {SITE_CONFIG.markets.map((market) => {
              ...
              return (
                <div
                  key={market.code}
                  className="flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-white/5 border border-white/[0.08] text-slate-300"
                >
