...
export function CommandPalette() {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-2xl bg-[#111827] border border-slate-700/90 rounded-2xl shadow-2xl shadow-blue-500/10 overflow-hidden flex flex-col"
        onClick={(e) => e.stopPropagation()}
        onKeyDown={handlePaletteKey}
      >
        {/* Search Input Bar */}
        <div className="flex items-center gap-3 px-4 py-3.5 border-b border-slate-700/60 bg-[#0A0E17]">
